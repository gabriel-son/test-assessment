/**
 * @file This file performs the actual validation, it serves as function
 *  which validates the incomming data before passing over control
...
module.exports = (req, schema, payload) => {
  ...
  payload.forEach((element, index) => {
     ...
     */
    const { error, value } = schema[index].validate(
    ...
    if (error) {
      ...
      const JoiError = {
        ...
        errors: _.map(error.details, ({ message, path }) => ({
          field: path[0],
